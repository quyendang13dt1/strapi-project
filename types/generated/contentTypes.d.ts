  ...
  attributes: {
    ...
    Content: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        ...
        {
          licenseKey: 'eyJhbGciOiJFUzI1NiJ9..GvoCi9Oss1Y66mEQ3jzQIiPzaod34Rj-hu-bLVBFZWZ6KrXo8df0kde_jsRVRVdcjEJoUnzl87NBfbWTIztYUg';
          output: 'HTML';
          preset: 'standard';
        }
      >;
...
export interface ApiContentTypeContentType extends Struct.CollectionTypeSchema {
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Menu: Schema.Attribute.Component<'button.button', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiKnowledgeHubKnowledgeHub
  extends Struct.CollectionTypeSchema {
...
export interface ApiWhitepaperWhitepaper extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    infoLink: Schema.Attribute.Component<'info-link.info-link', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
