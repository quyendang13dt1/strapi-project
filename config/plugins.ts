...
module.exports = ({ env }) => {
  ...
  setTimeout(() => {
    ...
    if (globalThis.CKEDITOR) {
          ...
          class CustomMediaEmbedEditing extends globalThis.CKEDITOR.plugins.mediaEmbedEditing {
        init() {
          super.init();
          ...
          providers: [
            {
              name: "synthesia",
              url: /^https:\/\/share\.synthesia\.io\/embeds\/videos\/.+/,
              html: match => `<iframe src="${match[0]}" width="640" height="360" frameborder="0" allowfullscreen></iframe>`,
            },
          ],
        },
      },
